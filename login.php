...
<html>
	...
	<body style="background-image: url('image/bg-image.jpeg');" id='login-body' class="bg-light">
		<div class="card col-md-4 offset-md-4 mt-4">
            ...
            <div class="card-body">
                    ...
                    <button class="btn btn-info btn-block" id="signup-frm" name="submit">Signup as Student</button>
            </div>
        </div>
